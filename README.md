...
We present an immersive LiDAR-based forest measurement system built on Apple Vision Pro (AVP) that enables gaze-aligned, accurate real-time distance estimation within reconstructed 3D environments.
